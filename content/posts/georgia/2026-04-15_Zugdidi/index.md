---
title: "Zome in Zugdidi"
date: 2026-04-15
draft: false
summary: "Wo wir mit dem Prinzen speisten und Louis Vuitton unsere Socken klaute."
tags: ["Stadt","Projekt"]
map:
  show: true
  location:
    name: Georgia-Zugdidi-WA_Zome
---
...
![Viele Personen in einem Auto](Rasselbande.jpg "Unsere Rasselbande.")
...
{{< accordion mode="close" separated=true >}}
  {{< accordionItem title="Extended Version" open=false  icon="circle-info" >}}
...
![Viele Schuhe in einem Flur](Schuhe.jpg "Wie unser Mitbewohner Alberic mit diesem Bild so nett bemerkte, \"_It’s difficult to make people believe that there are only 4 of us._\" 😉") 
...
{{< video src="YogaVid.mp4" autoplay=false loop=false muted=false caption="Kundalini Yoga: Finde die Person die nicht allzu vertraut mit den Vorgängen ist." >}}
...
![Große Agaben-artige Pflanze am unteren Ende ausgegraben und mit einer Schinge, die an einem Auto befestigt ist.](Agaven.jpg "_Team Destructeur_ fast am Ziel ... RIPflanze 🪴🪦")
...
{{< video src="Party.mp4" autoplay=false loop=false muted=false caption="_HIGHWAY TO HELL_ ...  oder zumindest aus der Wohnung." >}}
...
{{< video src="Hitchhiking.webm" autoplay=false loop=false muted=false caption="Eindrücke unseres kleinen _Wettbewerbs_." >}}
...
![Rot beleuchtete Mauer mit Schrift Megobar](Megobar.jpg "Unseren letzten Abend verbrachten wir gemeinsam in der MegoBar.")
