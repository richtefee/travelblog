...
map:
  show: true
  location:
    name: Georgia-Akhaltskihe-Hotel
---

## Warum einfach wenns auch kompliziert geht?
Wie auch bei der Anfahrt unseres letzten Stopps stellte sich auch diesmal nicht die Frage, ob wir per Anhalter fahren würden, sondern lediglich wie. Da der Pass in unserem Tal, wie wir [zuvor erwanderten](/posts/georgia/2026-05-10_Gomi), gesperrt war, blieben uns noch zwei Routen: die übliche (langweilige) über die Autobahn nach Tbilisi, und die aufregende über kleine Straßen im Berghinterland durch das Nachbartal. Dreimal dürft ihr raten für welche wir uns entschieden haben. 😀
...
{{< carousel images="Akhaltsikhe_Castle/*" >}}
...
{{< video src="LKW.webm" autoplay=false loop=false muted=false caption="Unsere LKW-Fahrt nahe der Grenze zu Armenien." >}}
...
{{< video src="Yerevan.webm" autoplay=false loop=false muted=false caption="DJ Rave auf dem Republic Square in Yerevan. Das Handy Microphone hat den knochenbebenden Bass wohl nicht so gut vertragen ... 🎤☠️!" >}}
